    ...
    <div className='payments-section flex-center'>
      ...
      <div className='payments-container flex-center'>
        ...
        <div className='payment-option flex-center'>
          ...
          <p className='payment-description'>
            Pay through GCash for a fast, cashless transaction. Simply open your
            GCash app, scan the QR code, or transfer to our official GCash
            number. Details will be provided at checkout.
          </p>
        </div>
      </div>
    </div>
